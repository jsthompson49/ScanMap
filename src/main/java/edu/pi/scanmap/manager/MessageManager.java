...
public class MessageManager {
    ...
    private static final String clientEndpoint = "a131ws0b6gtght-ats.iot.us-east-1.amazonaws.com";   // use value returned by describe-endpoint --endpoint-type "iot:Data-ATS"
    ...
    public MessageManager(final AwsCredentials awsCredentials) throws Exception {
